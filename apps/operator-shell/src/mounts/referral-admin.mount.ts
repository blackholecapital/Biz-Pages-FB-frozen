// Mount: referral-admin touchpoint on sf.cli.factory
...
export function isMountAuthorized(): boolean {
  return REFERRAL_ADMIN_MOUNT.surface_id === SURFACE_IDS.CLI_FACTORY;
}
