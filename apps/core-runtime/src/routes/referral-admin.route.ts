// Route consumer: referral-admin
// DOWNSTREAM STATUS: non-authoritative — no route exposure outside canonical authority
// RB-INT-CHASSIS-001 — chassis-native referral-admin route on sf.api.factory
...
export const REFERRAL_ADMIN_ROUTE: Route = {
